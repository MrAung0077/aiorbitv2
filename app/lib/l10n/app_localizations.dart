...
abstract class AppLocalizations {
  ...
  ///
  /// In en, this message translates to:
  /// **'One Prompt. Best AI. Best Result.'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Your intelligent workspace for every task.'**
  ...
  /// No description provided for @missionComingSoon.
  ///
  /// In en, this message translates to:
  /// **'Mission system is coming soon.'**
  String get missionComingSoon;

  /// No description provided for @historyComingSoon.
  ///
  /// In en, this message translates to:
  /// **'Chat and AI activity history is coming soon.'**
